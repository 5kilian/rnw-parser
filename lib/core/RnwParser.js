        ...
        if (figure !== undefined) {
            (figure instanceof Array ? figure : [figure]).forEach(raw => {
                ...
                if (type === 'Arc') {
                    ...
                    figure.FillColor = parseColor(raw.graphics.fill.color);
                ...
                figures.push(figure);
                if (raw.initialMarking !== undefined || raw.name !== undefined || raw.inscription !== undefined) {
                    let textType = raw.name === undefined ? raw.inscription === undefined ?
                        'initialMarking' : 'inscription' : 'name';
                    figures.push({
                        type: 'Text',
                        text: raw[textType].text,
                        align: 'center',
                        position: {
                            x: parseInt(raw.graphics.position.x),
                            y: parseInt(raw.graphics.position.y)
                        },
                        offset: {
                            x: parseInt(raw[textType].graphics.offset.x),
                            y: parseInt(raw[textType].graphics.offset.y)
                        },
